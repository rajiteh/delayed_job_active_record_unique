...
require "delayed_job_active_record_unique"
...
require "generators/delayed_job/templates/unique_id"

ActiveRecord::Schema.define do
  CreateDelayedJobs.up
  AddUniqueIdToDelayedJobs.up
...
class CustomJob < Struct.new(:custom_job_id)
